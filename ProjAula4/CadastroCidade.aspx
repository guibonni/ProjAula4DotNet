...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>
                <asp:Label ID="LblTitulo" runat="server" Text="Cadastro de Cidades"></asp:Label>
            </h1>
            ...
            <p><asp:Label ID="LblEstado" runat="server" Text="Estado"></asp:Label></p>
            <p>
        ...
        <br />
        <br />
        <asp:GridView ID="GVCidade" runat="server" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
